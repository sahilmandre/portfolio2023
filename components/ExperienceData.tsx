  ...
  return (
    ...
    >
      ...
      <div className="px-1 md:px-10 md:pr-4 ">
        ...
        <ul className="list-disc space-y-1 ml-5 text-lg h-[15rem] sm:max-h-[8rem]  md:max-h-[10rem] overflow-y-scroll scrollbar-thin scrollbar-track-black scrollbar-thumb-[#f7ab0a]/80">
